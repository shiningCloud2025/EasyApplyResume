...
@Slf4j
@Service
public class AdminLoginAndRegisterEmailVerifyServiceImpl implements AdminLoginAndRegisterEmailVerifyService {
    @Resource
    ...
    @Value("${admin.email.verify.code.expire-seconds}")
    private long codeExpireSeconds;

    @Value("${admin.email.verify.code.redis-prefix}")
    private String codeRedisPrefix;

    @Value("${admin.email.verify.email.send-interval-seconds}")
    private long sendIntervalSeconds;

    @Value("${admin.email.verify.email.redis-prefix}")
    private String sendRecordRedisPrefix;

    @Value("${admin.email.verify.email.subject}")
