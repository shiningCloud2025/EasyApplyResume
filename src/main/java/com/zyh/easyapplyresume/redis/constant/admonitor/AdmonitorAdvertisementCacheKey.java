...
/**
 * 监测端广告缓存Key常量
 * Service: AdmonitorAdvertisementService
 * @author shiningCloud2025
 */
public interface AdmonitorAdvertisementCacheKey {
    
    /**
     * Service名称
     */
    String SERVICE_NAME = "admonitorAdvertisement";
    
    // ==================== Key定义 ====================
    
    /**
     * findAllAdmonitorAdvertisement() - 查询所有广告
     * 格式: admonitor_admonitorAdvertisement_list
     */
    ...
    /**
     * findAdmonitorAdvertisementByPage(pageNum, pageSize, query) - 分页查询广告
     * 格式: admonitor_admonitorAdvertisement_page_{pageNum}_{pageSize}_{queryHash}
     */
    ...
    /**
     * findAdmonitorAdvertisementById(id) - 查询广告详情
     * 格式: admonitor_admonitorAdvertisement_get_{id}
     */
