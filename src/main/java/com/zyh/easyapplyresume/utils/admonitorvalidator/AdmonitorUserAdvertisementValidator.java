...
/**
 * 用户端广告表单检查工具类，用于验证用户端广告表单数据
 * 支持新增场景和修改场景的字段校验
 * @author shiningCloud2025
 */
public class AdmonitorUserAdvertisementValidator {
     ...
     * @param admonitorUserAdvertisementForm 待验证的用户端广告表单对象
     * @throws BusException 字段不满足规则时抛出
     */
    public static void validateForAdd(AdmonitorUserAdvertisementForm admonitorUserAdvertisementForm) {
        // 通用字段校验（新增/修改一致）
        validateCommonFields(admonitorUserAdvertisementForm);
    }
     ...
     * @throws BusException 字段不满足规则时抛出
     */
    public static void validateForUpdate(AdmonitorUserAdvertisementForm admonitorUserAdvertisementForm) {
        // 通用字段校验（新增/修改一致）
        validateCommonFields(admonitorUserAdvertisementForm);
        // 修改场景专属：校验广告主键ID
        validateAdvertisementId(admonitorUserAdvertisementForm);
    }

    /**
     * 私有辅助方法：校验新增/修改通用字段
     * @param form 待验证的用户端广告表单对象
     * @throws BusException 字段不满足规则时抛出
     */
    private static void validateCommonFields(AdmonitorUserAdvertisementForm form) {
        // 1. 校验广告名称
     ...
     */
    private static void validateAdvertisementName(AdmonitorUserAdvertisementForm form) {
     ...
     */
    private static void validateAdvertisementUrl(AdmonitorUserAdvertisementForm form) {
     ...
     */
    private static void validateAdvertisementLink(AdmonitorUserAdvertisementForm form) {
     ...
     */
    private static void validateAdvertisementTime(AdmonitorUserAdvertisementForm form) {
     ...
     */
    private static void validateAdvertisementId(AdmonitorUserAdvertisementForm form) {
