...
public enum AdminCodeEnum {
    ...
    SCORE_MODEL_VERSION_MODEL_FILE_EMPTY(1097, "模型文件不能为空"),
    SCORE_MODEL_VERSION_MODEL_FILE_NAME_EMPTY(1098, "模型文件名不能为空"),
    SCORE_MODEL_VERSION_MODEL_FILE_NAME_TOO_LONG(1099, "模型文件名不能超过512个字符"),
    SCORE_MODEL_VERSION_COUNT_LIMIT(1100, "模型文件最多只能保留10个"),
    SCORE_MODEL_VERSION_NOT_FOUND(1101, "模型版本不存在"),
