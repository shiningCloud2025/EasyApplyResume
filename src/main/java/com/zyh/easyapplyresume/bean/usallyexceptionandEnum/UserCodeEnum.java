...
public enum UserCodeEnum {
    ...
    USER_QUESTION_BANK_ANSWER_FORM_EMPTY(10125, "用户题库题目作答表单不能为空"),
    USER_QUESTION_BANK_ANSWERS_EMPTY(10126, "用户作答答案不能为空"),
    USER_QUESTION_BANK_SUBMIT_FAIL(10127, "用户端题库题目作答失败"),
