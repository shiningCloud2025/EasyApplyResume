...
public enum AdMonitorCodeEnum {
    ...
    // ===================== 服务器业务相关 (20060-20090) ====================
    SERVICE_MACHINE_NAME_EMPTY(20060, "服务器名称不能为空"),
    SERVICE_MACHINE_NAME_TOO_LONG(20061, "服务器名称不能超过25个字符"),
    SERVICE_MACHINE_HOST_EMPTY(20062, "外网IP/域名不能为空"),
    SERVICE_MACHINE_HOST_TOO_LONG(20063, "外网IP/域名不能超过255个字符"),
    SERVICE_MACHINE_PORT_EMPTY(20064, "SSH端口不能为空"),
    SERVICE_MACHINE_PORT_TOO_LONG(20065, "SSH端口位数不合法"),
    SERVICE_MACHINE_USERNAME_EMPTY(20066, "登录账号不能为空"),
    SERVICE_MACHINE_USERNAME_TOO_LONG(20067, "登录账号不能超过60个字符"),
    SERVICE_MACHINE_PASSWORD_EMPTY(20068, "登录密码不能为空"),
    SERVICE_MACHINE_PASSWORD_TOO_LONG(20069, "登录密码不能超过60个字符"),
    SERVICE_MACHINE_REMARK_EMPTY(20070, "备注不能为空"),
    SERVICE_MACHINE_REMARK_TOO_LONG(20071, "备注不能超过200个字符"),
    SERVICE_MACHINE_ID_ILLEGAL(20072, "服务器ID不合法"),
