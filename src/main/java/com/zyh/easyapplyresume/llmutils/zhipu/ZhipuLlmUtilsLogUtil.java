...
/**
 * 智谱大模型调用日志工具类
 * 用于统一记录zhipu包下各类AI工具的调用日志
 *
 * @author shiningCloud2025
 */
@Slf4j
@Component
public class ZhipuLlmUtilsLogUtil {
    @Autowired
    ...
    public void saveSuccessLog(String toolClass, String toolDescription, String inputContent, String outputResult, long startTime) {
        try {
            ...
            form.setLlmUtilsInfoModelProvider("智谱AI");
            form.setLlmUtilsInfoModelName("glm-4-air");
