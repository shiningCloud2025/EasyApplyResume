...
public class AdminJobAdviceArticleController {
    ...
    @PreAuthorize("hasAuthority('/admin/jobAdviceArticle/addJobAdviceArticle')")
    ...
    @PreAuthorize("hasAuthority('/admin/jobAdviceArticle/updateJobAdviceArticle')")
    ...
    @PreAuthorize("hasAuthority('/admin/jobAdviceArticle/deleteJobAdviceArticle')")
    ...
    @PreAuthorize("hasAuthority('/admin/jobAdviceArticle/getJobAdviceArticleInfo')")
    ...
    @PreAuthorize("hasAuthority('/admin/jobAdviceArticle/getJobAdviceArticlePage')")
