...
public class AdminUserFeedbackRecordController {
    ...
    @PreAuthorize("hasAuthority('/admin/userfeedbackRecord/findUserFeedbackRecordByFeedbackRecordId')")
    ...
    @PreAuthorize("hasAuthority('/admin/userfeedbackRecord/findUserFeedbackRecordPage')")
