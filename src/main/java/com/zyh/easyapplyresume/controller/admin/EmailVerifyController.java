...
import com.zyh.easyapplyresume.service.impl.admin.EmailVerifyServiceImpl;
...
public class EmailVerifyController {
     ...
     */
    @PostMapping("/send")
    public BaseResult<?> sendVerifyCode(@RequestParam String email) {
     ...
     */
    @PostMapping("/check")
    public BaseResult<?> checkVerifyCode(@RequestParam String email, @RequestParam String code) {
