import{r as x,j as e}from"./index-e89e22e3.js";import{r as m}from"./react-vendor-fa9da516.js";import{j as v,U as A,aE as w,B as D,a5 as N,I as C,m as O}from"./antd-vendor-239589cc.js";const R={applicationChat:(a,n)=>x.post("/user/aiResumeAssistant/application/chat",a,{params:{chatId:n},headers:{Accept:"text/event-stream"}}),agentChat:(a,n)=>x.post("/user/aiResumeAssistant/agent/chat",a,{params:{chatId:n},headers:{Accept:"text/event-stream"}})},{TextArea:E}=C,L=()=>{const[a,n]=m.useState(!1),[o,h]=m.useState(""),[f,S]=m.useState(),[j,p]=m.useState([{id:1,type:"assistant",content:`您好！我是您的AI求职助手，我可以帮助您：
...
还有其他我可以帮助您的吗？`},y=t=>{t.key==="Enter"&&!t.shiftKey&&(t.preventDefault(),g())};return e.jsx("div",{className:"ai-assistant-page",children:e.jsxs(v,{className:"chat-container",title:"AI求职助手",children:[e.jsx("div",{className:"chat-messages",children:j.map(t=>e.jsxs("div",{className:`message ${t.type}`,children:[e.jsx("div",{className:"message-avatar",children:t.type==="user"?e.jsx(A,{}):e.jsx(w,{})}),e.jsxs("div",{className:"message-content",children:[e.jsx("div",{className:"message-text",children:t.content.split(`
`).map((s,i)=>e.jsx("p",{children:s},i))}),e.jsx("div",{className:"message-time",children:new Date(t.timestamp).toLocaleTimeString("zh-CN",{hour:"2-digit",minute:"2-digit"})})]})]},t.id))}),e.jsxs("div",{className:"chat-input",children:[e.jsx(E,{value:o,onChange:t=>h(t.target.value),onKeyPress:y,placeholder:"请输入您的问题...",rows:3,disabled:a}),e.jsx(D,{type:"primary",icon:e.jsx(N,{}),onClick:g,loading:a,disabled:!o.trim(),children:"发送"})]})]})})};export{L as default};
