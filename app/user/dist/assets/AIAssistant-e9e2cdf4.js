import{r as x,j as e}from"./index-610f6630.js";import{r as m}from"./react-vendor-fa9da516.js";import{o as v,U as A,ak as w,B as D,ad as N,I as C,m as O}from"./antd-vendor-aeb4324b.js";const R={applicationChat:(a,n)=>x.post("/user/aiResumeAssistant/application/chat",a,{params:{chatId:n},headers:{Accept:"text/event-stream"}}),agentChat:(a,n)=>x.post("/user/aiResumeAssistant/agent/chat",a,{params:{chatId:n},headers:{Accept:"text/event-stream"}})},{TextArea:k}=C,L=()=>{const[a,n]=m.useState(!1),[o,h]=m.useState(""),[f,S]=m.useState(),[y,p]=m.useState([{id:1,type:"assistant",content:`您好！我是您的AI求职助手，我可以帮助您：
...
`).map((s,i)=>e.jsx("p",{children:s},i))}),e.jsx("div",{className:"message-time",children:new Date(t.timestamp).toLocaleTimeString("zh-CN",{hour:"2-digit",minute:"2-digit"})})]})]},t.id))}),e.jsxs("div",{className:"chat-input",children:[e.jsx(k,{value:o,onChange:t=>h(t.target.value),onKeyPress:j,placeholder:"请输入您的问题...",rows:3,disabled:a}),e.jsx(D,{type:"primary",icon:e.jsx(N,{}),onClick:g,loading:a,disabled:!o.trim(),children:"发送"})]})]})})};export{L as default};
