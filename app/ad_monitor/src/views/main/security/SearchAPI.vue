            ...
            <div class="features">
              <div class="feature-item">
                ...
                <div class="feature-content">
                  <span class="feature-title">实时数据</span>
                  <span class="feature-desc">即时搜索结果</span>
                </div>
              </div>
              <div class="feature-item">
                <div class="feature-icon">
                ...
                <div class="feature-content">
                  <span class="feature-title">精准定位</span>
                  <span class="feature-desc">坐标级地理定位</span>
                </div>
              </div>
              <div class="feature-item">
                <div class="feature-icon">
                ...
                <div class="feature-content">
                  <span class="feature-title">高成功率</span>
                  <span class="feature-desc">99.9%成功率</span>
                </div>
              </div>
              <div class="feature-item">
                <div class="feature-icon">
                ...
                <div class="feature-content">
                  <span class="feature-title">按需付费</span>
                  <span class="feature-desc">仅为成功搜索付费</span>
                </div>
              </div>
            </div>
...
const canOpenPlatform = computed(() => authStore.canAccessRoute(externalSystemPermissions.searchapi))
const loading = ref(false)
const platformURL = 'https://www.searchapi.io/'

const openPlatform = async () => {
  if (!canOpenPlatform.value) {
    ElMessage.warning('暂无 SearchAPI 平台权限')
    return
  }
  loading.value = true
  try {
