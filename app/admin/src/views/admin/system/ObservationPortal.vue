  ...
  <div class="portal-docs">
    <div class="docs-content">
      <div class="welcome-card">
        ...
        <el-card class="main-card observation-card" shadow="hover">
          <div class="welcome-content">
            <div class="icon-wrapper">
              <div class="icon-bg observation-icon">
            ...
            <div class="features">
              <div class="feature-item">
                <div class="feature-icon observation-feature">
                  <i class="el-icon-data-analysis"></i>
                </div>
                <div class="feature-content">
                  <span class="feature-title">数据监控</span>
                  <span class="feature-desc">实时系统运行状态</span>
                </div>
              </div>
              <div class="feature-item">
                <div class="feature-icon observation-feature">
                ...
                <div class="feature-content">
                  ...
                  <span class="feature-desc">用户行为深度分析</span>
                </div>
              </div>
              <div class="feature-item">
                <div class="feature-icon observation-feature">
                ...
                <div class="feature-content">
                  <span class="feature-title">广告管理</span>
                  <span class="feature-desc">广告投放与效果监测</span>
                </div>
              </div>
              <div class="feature-item">
                <div class="feature-icon observation-feature">
                ...
                <div class="feature-content">
                  ...
                  <span class="feature-desc">异常情况及时预警</span>
                </div>
              </div>
            </div>
            
            <div class="action-section observation-action">
              <div class="action-content">
                <div class="action-icon observation-action-icon">
                  <i class="el-icon-right"></i>
                </div>
                <div class="action-text">
                  <h3>访问观测端</h3>
                  <p>点击下方按钮在新窗口中打开易投简历观测与广告端系统</p>
                </div>
              </div>
              <el-button 
                size="large" 
...
.features {
  ...
  .feature-item {
    ...
    &:hover {
      ...
      box-shadow: 0 12px 25px rgba(245, 87, 108, 0.2);
